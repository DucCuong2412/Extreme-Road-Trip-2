...
public class GameAdProvider : AdProvider<GameAdProvider>
{
	...
	{
		return false;//AutoSingleton<MetroMenuStack>.Instance.Peek() is MetroPopupMessage;
	}
	...
	{
		return false;//AutoSingleton<MetroMenuStack>.Instance.Peek() as PopupBikeTripPromo == null;
	}
	...
	{
		return null;//CreateFreeCrateButtonMenuChooseCar(iconScale, MetroSkin.Slice9StoreSquare, Color.black);
	}
	...
	public MetroButton CreateFreeCrateButtonMenuChooseCar(float iconScale, string bgSlice9, Color textColor)
	{
		...
		//	UpdateChooseCarButtonBadge();
		//};
		return null;//CreateFreeCrateButton(onPopupDismiss, metroButton);
	}
	...
	public MetroButton CreateFreeCrateButtonMenuMain(Action onPopupDismiss)
	{
		...
		//{
		//};
		return null;// CreateFreeCrateButton(onPopupDismiss, button);
	}
	...
	{
		return false;// _interstitialEnabled.Get();
	}
