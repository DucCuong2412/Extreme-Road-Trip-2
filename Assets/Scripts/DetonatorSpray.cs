	...
	public override void Explode()
	{
		...
		if (_explodeDelay <= 0f)
		{
			...
			for (int i = 0; i < num; i++)
			{
				...
				GameObject gameObject = Object.Instantiate(sprayObject, base.transform.position + b, base.transform.rotation) as GameObject;
				...
				gameObject.rigidbody.velocity = Vector3.Scale(b.normalized, b2);
				UnityEngine.Object.Destroy(gameObject, duration * timeScale);
